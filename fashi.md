...
<div style="max-width: 1000px; margin: 0 auto; padding: 0 1rem;">
  ...
  <!-- ============ SURVEY STRATEGY ============ -->
  <section style="margin-bottom: 2.5rem; padding: 0 1rem;">
    <h2 style="border-bottom: 2px solid #159957; padding-bottom: 0.3rem; font-size: 1.6rem; color: #159957;">Survey Strategy and Observations</h2>
    ...
    <div style="overflow-x: auto; margin: 1rem 0;">
      <table style="width: 100%; border-collapse: collapse; font-size: 0.95rem; background: #fff; box-shadow: 0 2px 6px rgba(0,0,0,0.06); border-radius: 6px;">
        ...
        <tbody>
          ...
          <tr><td style="padding: 8px 16px; border-bottom: 1px solid #eee;">Redshift <em>z</em> range</td><td style="padding: 8px 16px; border-bottom: 1px solid #eee;"><em>z</em> &lt; 0.0878</td></tr>
          <tr><td style="padding: 8px 16px; border-bottom: 1px solid #eee;">Spectral channels</td><td style="padding: 8px 16px; border-bottom: 1px solid #eee;">65,536 (before smoothing)</td></tr>
  ...
  <section style="margin-bottom: 2.5rem; padding: 0 1rem;">
    ...
    <ol style="line-height: 2.0; padding-left: 1.5rem; font-size: 0.95rem;">
      ...
      <li>The complete Table 2 containing 41,741 sources can be accessed in <a href="{{ site.baseurl }}/img/Table2-FASHI_extragalactic_HI_source_catalog.csv" target="_blank" style="color: #1e6bb8;">FASHI Extragalactic H I Source Catalog</a></li>
      ...
      <li>The complete Table 4 containing 14,072 sources can be accessed in <a href="{{ site.baseurl }}/img/Table4-The_identified_optical_counterparts_from_the_SGA_catalog.csv" target="_blank" style="color: #1e6bb8;">Identified Optical Counterparts from the SGA Catalog</a></li>
      <li>The complete Table 5 containing 2,900 sources can be accessed in <a href="{{ site.baseurl }}/img/Table5-The_identified_optical_counterparts_from_the_SDSS_spectroscopic_catalog.csv" target="_blank" style="color: #1e6bb8;">Identified Optical Counterparts from the SDSS Spectroscopic Catalog</a></li>
      <li>The complete Table 6 containing 10,975 sources can be accessed in <a href="{{ site.baseurl }}/img/Table6-The_identified_optical_counterparts_from_the_SDSS_photometric_catalog.csv" target="_blank" style="color: #1e6bb8;">Identified Optical Counterparts from the SDSS Photometric Catalog</a></li>
    </ol>
  </section>
  ...
  <section style="margin-bottom: 2.5rem; padding: 0 1rem;">
    ...
    <ul style="line-height: 2.0; padding-left: 1.5rem; font-size: 0.95rem;">
      ...
      <li><a href="https://www.eurekalert.org/news-releases/1029943" target="_blank" style="color: #1e6bb8;">【EurekAlert】FASHI Releases the Largest Extragalactic H I Catalog with FAST</a></li>
    </ul>
  </section>
